...
public class HandleScrollFeature {
    public static void scrollScreen(AppiumDriver appiumDriver, int startX, int endX, int startY, int endY) {
        ...
        Sequence sequence = new Sequence(pointerInput, 1)
                ...
                .addAction(new Pause(pointerInput, Duration.ofMillis(500)))
                .addAction(pointerInput.createPointerMove(Duration.ofMillis(500), PointerInput.Origin.viewport(), endX, endY))
